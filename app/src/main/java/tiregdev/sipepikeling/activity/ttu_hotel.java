...
public class ttu_hotel extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_ttu_hotel);
    ...
    private void submitHOTEL(String namaTempat, String noTelp, String namaPimpinan, String jumlahKaryawan,
        ...
        String pushID = mDatabase.child("ttu").child("hotel").push().getKey();
        mDatabase.child("ttu").child("hotel").child(pushID).child("data").setValue(setPasar);
        mDatabase.child("ttu").child("hotel").child(pushID).child("nilai").setValue(nilaiTPM);
