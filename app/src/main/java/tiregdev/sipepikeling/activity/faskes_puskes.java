...
import tiregdev.sipepikeling.model.PUSKESMAS;
import tiregdev.sipepikeling.utils.SessionString;

public class faskes_puskes extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_faskes_puskes);
    ...
    private void onSubmit(){
        if(!frmNamaTempat.getText().toString().trim().equals("") && !frmNamaPengelola.getText().toString().trim().equals("")
            ...
            String namaPuskesmas = frmNamaTempat.getText().toString().trim();
            String namaPimpinan = frmNamaPengelola.getText().toString().trim();
            ...
            submitPUSKESMAS(namaPuskesmas, namaPimpinan, idPetugas,
    ...
    private void submitPUSKESMAS(String namaPuskesmas, String namaPimpinan, String idPetugas, String waktu, String alamat, String koordinat, double totalNilai, String status, HashMap<String, String> nilaiTPM){

        PUSKESMAS setPasar = new PUSKESMAS(namaPuskesmas, namaPimpinan, idPetugas,
                waktu, alamat, koordinat, totalNilai, status);
        String pushID = mDatabase.child("ttu").child("puskesmas").push().getKey();
        mDatabase.child("ttu").child("puskesmas").child(pushID).child("data").setValue(setPasar);
        mDatabase.child("ttu").child("puskesmas").child(pushID).child("nilai").setValue(nilaiTPM);
