...
public class KOLAM {
    ...
    public KOLAM(String namaTempat, String noTelp, String namaPengelola, String jumlahKaryawan, String noIzinUsaha, String idPetugas, String waktu, String alamat, String koordinat, double totalNilai, String status) {
