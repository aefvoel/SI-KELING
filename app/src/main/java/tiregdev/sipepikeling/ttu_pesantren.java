...
public class ttu_pesantren extends AppCompatActivity {
    ...
    private void onSubmit(){
        if(!frmNamaTempat.getText().toString().trim().equals("") && !frmNamaPengelola.getText().toString().trim().equals("")
            ...
            String jumlahSantri = frmJmlSantri.getText().toString().trim();;
            ...
            submitPESANTREN(namaTempat, namaPengelola, jumlahSantri, idPetugas,
    ...
    private void submitPESANTREN(String namaPesantren, String namaPengelola, String jumlahSantri, String idPetugas, String waktu, String alamat, String koordinat, double totalNilai, String status, HashMap<String, String> nilaiTPM){

        PESANTREN setPasar = new PESANTREN(namaPesantren, namaPengelola, jumlahSantri, idPetugas,
                waktu, alamat, koordinat, totalNilai, status);
        String pushID = mDatabase.child("ttu").child("pesantren").push().getKey();
        mDatabase.child("ttu").child("pesantren").child(pushID).child("data").setValue(setPasar);
        mDatabase.child("ttu").child("pesantren").child(pushID).child("nilai").setValue(nilaiTPM);
